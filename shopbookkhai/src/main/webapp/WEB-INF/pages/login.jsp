					...
					<div class="row">
						...
						<div class="col-lg-6 col-md-6 col-sm-4 col-xs-12">
							<div class="logo-area text-center logo-xs-mrg">
								<a href="index"><img src="img/logo/logo.png" alt="logo" /></a>
							</div>
						</div>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="menu-area">
								<nav>
									<ul>
										<li class="active"><a href="index">Trang chủ<i class="fa fa-angle-down"></i></a>
		...
		<div class="user-login-area mb-70">
			<div class="container">
				<div class="row">
					...
					<form action="xulylogin" method="get">
						...
						<div class="login-form">
							...
							<div class="single-login single-login-2">
								<input type="submit" value="Đăng nhập" style="background:#F07C29;text-color:#FFF2BE;">
								<!-- <a href="#">login</a> -->
